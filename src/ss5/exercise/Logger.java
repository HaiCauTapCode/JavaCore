...
public class Logger {
    ...
    public static final String WHITE_OG = "ax2dc6cs";
    ...
    public static void secondary(String text) {
        System.out.print(GREEN_BOLD_BRIGHT + text + RESET);
    }
    ...
    public static void error(String text) {
        System.err.print(RED + text + RESET);
    }

    public static void dark(String text) {
    ...
    public static void logException(Class<?> clazz, Exception ex, String... log) {
        try {
            ...
            // Lấy method gọi thực sự (không phải Logger class)
            String methodName = "unknown";
            for (StackTraceElement el : Thread.currentThread().getStackTrace()) {
                if (!el.getClassName().equals(Logger.class.getName())) {
            ...
            if (log != null && log.length > 0) {
                Logger.log(PURPLE, String.join(" | ", log) + "\n");
            }
            Logger.error("Error in class: " + clazz.getName() + "\n");
            Logger.error("In method: " + methodName + "\n");
